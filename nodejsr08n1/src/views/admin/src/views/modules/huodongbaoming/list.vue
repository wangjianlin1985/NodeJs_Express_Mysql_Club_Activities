  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
	    ...
	    <download-excel v-if="isAuth('huodongbaoming','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "活动报名.xls">
		      <!-- 导出excel -->
            	<el-button
...
//导出excel
      json_fields: {
      "活动名称": "huodongmingcheng",    //常规字段
      "社团名称": "shetuanmingcheng",    //常规字段
      "账号": "zhanghao",    //常规字段
      "报名内容": "baomingneirong",    //常规字段
      "报名日期": "baomingriqi",    //常规字段
      "学号": "xuehao",    //常规字段
      "姓名": "xingming",    //常规字段
      "手机": "shouji",    //常规字段
      "是否审核": "sfsh",    //常规字段
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          baomingneirong: row.baomingneirong,
          baomingriqi: row.baomingriqi,
          xuehao: row.xuehao,
