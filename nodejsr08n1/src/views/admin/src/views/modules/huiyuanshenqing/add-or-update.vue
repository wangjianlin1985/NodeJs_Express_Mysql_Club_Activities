<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团类型" prop="shetuanleixing">
          <el-input v-model="ruleForm.shetuanleixing" 
              placeholder="社团类型" clearable  :readonly="ro.shetuanleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团类型" prop="shetuanleixing">
              <el-input v-model="ruleForm.shetuanleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请理由" prop="shenqingliyou">
          <el-input v-model="ruleForm.shenqingliyou" 
              placeholder="申请理由" clearable  :readonly="ro.shenqingliyou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请理由" prop="shenqingliyou">
              <el-input v-model="ruleForm.shenqingliyou" 
                placeholder="申请理由" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huiyuanshenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huiyuanshenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
