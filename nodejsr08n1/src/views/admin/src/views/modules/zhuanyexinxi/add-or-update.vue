<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业名称" prop="zhuanyemingcheng">
          <el-input v-model="ruleForm.zhuanyemingcheng" 
              placeholder="专业名称" clearable  :readonly="ro.zhuanyemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业名称" prop="zhuanyemingcheng">
              <el-input v-model="ruleForm.zhuanyemingcheng" 
